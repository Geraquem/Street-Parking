...
class GetSpotsUseCase @Inject constructor() {
    operator fun invoke(): List<Spot> {
        return listOf(
            ...
            Spot("C", 40.392925, -3.708986, 124269, 27),
            Spot("C", 40.393456, -3.709455, 124269, 27),
            Spot("C", 40.396440, -3.707701, 124269, 27),
            Spot("C", 40.392801, -3.702259, 124269, 27),
            Spot("C", 40.393930, -3.698981, 124269, 27),
            Spot("C", 40.394156, -3.711954, 124269, 27),
            Spot("C", 40.391405, -3.706135, 124269, 27),
        )
    }
}